...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("DONATE_ARMY_MUSIC/assets/font2.ttf", 30)
    font = ImageFont.truetype("DONATE_ARMY_MUSIC/assets/font.ttf", 30)
    title_font = ImageFont.truetype("DONATE_ARMY_MUSIC/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("DONATE_ARMY_MUSIC/assets/play_icons.png")
