...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    font = ImageFont.truetype("DONATE_ARMY_MUSIC/assets/font.ttf", size=95)
    welcome_font = ImageFont.truetype("DONATE_ARMY_MUSIC/assets/font.ttf", size=45)
...
async def greet_new_member(
    ...
    if member.new_chat_member and not member.old_chat_member:
        ...
        try:
            ...
            pic = "DONATE_ARMY_MUSIC/assets/upic.png"
